...
python3 -m egg.zoo.simple_autoenc.train --n_objects=4 --n_dim=2 --vocab_size=2 --max_len=5 --sender_cell=rnn --receiver_cell=rnn --checkpoint_dir="../tmp/checkpoint" --preemptable --checkpoint_freq=1
# =======
